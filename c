...
Plugin.prototype.attachImage = function(url,alt_text,index) {
    ...
    img.css({'position':'relative'}, {'-webkit-transform': 'translate3d(0,0,0)'}, {'-ms-transform': 'translate3d(0,0,0)'}, {'transform': 'translate3d(0,0,0)'}, {'-moz-transform': 'translate3d(0,0,0)'}, {'padding-top':70});
...
$(document).ready(function(){
    <!-- Add the Logo Image -->
    var $logo = $('<a class="adLogo" href="' + jsonData.logoAction + '" style="float: left; height: 70px" target="blank">' +
            '<div style="background: ' + jsonData.logoBackground + '; display: table-cell; text-align: center; vertical-align: middle; width: 300px; height: 70px;">' +
            '<img src="' + jsonData.logoImg+ '" style="max-width: 130px; background: transparent;">' +
            '</div>' +
            '</a>');
...
<div id="wrapper" style="width: 298px; height: 248px; margin: 0 auto; position: relative; border: 1px solid; overflow: hidden">
    <div class="fixedContent" style="position: absolute; top: 0px; z-index: 999;"></div>
</div>
